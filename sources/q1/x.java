...
public final class x implements c {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!k.a(x.class, obj != null ? obj.getClass() : null)) {
            return false;
        }
        k.c(obj, "null cannot be cast to non-null type androidx.wear.watchface.complications.data.TimeDifferenceComplicationText");
        x xVar = (x) obj;
